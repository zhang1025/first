...
CREATE TABLE `out_month_plan` (
  ...
  `usePerson` varchar(255) DEFAULT NULL COMMENT '经办人',
  `inputPerson` varchar(255) DEFAULT NULL COMMENT '录入人',
  `planMonth` varchar(50) DEFAULT NULL COMMENT '所属计划月份',
  `createtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `payId` int(11) DEFAULT NULL COMMENT '交款单号',
...
-- ----------------------------
INSERT INTO `out_month_plan` VALUES ('2', '1', '吉林亚泰水泥有限公司', '50', '1', '120', '3', '132', '太平井', '洗精煤', '烟筒山', '公司专', '吉林亚泰集团物资贸易有限公司', '合同户', '看韩剧', 'admin','03', '2017-03-23 23:31:49', '1490', '1');
INSERT INTO `out_month_plan` VALUES ('3', '2', '中国石油天然气股份有限', '50', '0', '120', '0', '58', '六区', '低质煤', '东辽阳', '公司专', '中国石油天然气股份有限公司', '支票', '二房东', 'admin', '03','2017-03-23 23:31:50', '5223', '1');
INSERT INTO `out_month_plan` VALUES ('4', '3', '白山市大业物贸有限公司', '123', '0', '231', '0', '52', '斜井', '大煤矿', '沈阳站', '公司专', '白山市大业物贸有限公司', '合同户', '都是热饭', 'admin','03', '2017-03-23 23:31:51', '5151', '1');
INSERT INTO `out_month_plan` VALUES ('5', '2', '中国石油天然气股份有限', '123', '3', '123', '9', '120', '斜井', '大煤矿', '沈阳站', '公司专', '中国石油天然气股份有限公司', '合同户', '具体一点', 'admin','03', '2017-03-23 23:56:57', '8768', '1');
INSERT INTO `out_month_plan` VALUES ('6', '1', '吉林亚泰水泥有限公司', '123', '1', '123', '2', '12', '太平井', '低质煤', '鞍山', '公司专', '吉林亚泰集团物资贸易有限公司', '合同户', '热污染', 'admin','03', '2017-03-24 23:37:34', '1255', '-1');
...
INSERT INTO `t_permission` VALUES ('15', '/finance/remit', '回款单录入', '回款单录入', '财务管理', '7');
INSERT INTO `t_permission` VALUES ('16', '/finance/balance', '结算单录入', '结算单录入', '财务管理', '8');
INSERT INTO `t_permission` VALUES ('17', '/finance/df', '合同审核', '合同审核', '财务管理', '9');
