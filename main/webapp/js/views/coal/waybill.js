...
function queryData() {
    ...
    var url = path+'/get_waybill_table';
    commonDataTables("waybillDataTables", url, aoColumns, params, "waybillData");
}
//处理table的公共title
...
function initButtonClick() {
    ...
    $("#submitBut").on("click", function () {
        ...
        var url = path + (subType == 1?"addWaybillInfo":"editWaybillInfo");
        $.post(url, {
