...
function queryData() {
    ...
    var url = path+'/get_shippingDetails_table';
    commonDataTables("shippingDetailsDataTables", url, aoColumns, params, "shippingDetailsData");
}
//处理table的公共title
...
function initButtonClick() {
    ...
    $("#submitBut").on("click", function () {
        ...
        var url = path + (subType == 1?"addDetailsInfo":"editDetailsInfo");
        $.post(url, {
