...
function queryData() {
    ...
    var url = path+'/get_emptyWeight_table';
    commonDataTables("emptyWeightDataTables", url, aoColumns, params, "emptyWeightData");
}
//处理table的公共title
...
function initButtonClick() {
    ...
    $("#submitBut").on("click", function () {
        ...
        var url = path + (subType == 1?"addEmptyWeightInfo":"editEmptyWeightInfo");
        $.post(url, {
