            ...
            <div class="row" id="coalData">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default toggle ">
                        <!-- Start .panel -->
                        <div class="panel-heading">
                            <h4 class="panel-title"><i class="fa fa-table">&nbsp;煤炭信息</i>
                            </h4>
                        </div>
                        <div class="panel-body">
    ...
    <div class="modal-dialog" style="width: 550px">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">煤炭信息</h4>
            </div>
            <div class="modal-body">
                <form id="validate" class="form-horizontal group-border stripped" role="form">
                    <div class="form-group">
                        <label for="name" class="col-lg-4 control-label" style="width:30%;padding-left: 20px;padding-right: 1px">煤炭名称:</label>
                        <div class="col-lg-10" style="width: 300px;padding-left: 5px">
                            <input type="text" id="name" class="form-control required" aria-required="true" placeholder="请输入煤炭名称    ">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="mnc" class="col-lg-4 control-label" style="width:30%;padding-left: 20px;padding-right: 1px">煤炭简记符:</label>
                        <div class="col-lg-10" style="width: 300px;padding-left: 5px">
                            <input type="text" id="mnc" class="form-control required" aria-required="true" placeholder="煤炭简记符">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="kind" class="col-lg-4 control-label" style="width:30%;padding-left: 20px;padding-right: 1px">煤炭种类:</label>
                        <div class="col-lg-10" style="width: 300px;padding-left: 5px">
                            <input type="text" id="kind" class="form-control required" aria-required="true" placeholder="煤炭种类">
                        </div>
                    </div>
                </form>
            </div>
...
<script src="<c:url value="/js/views/dataPage/coalData.js"/> "></script>
