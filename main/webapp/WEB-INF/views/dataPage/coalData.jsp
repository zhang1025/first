                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2" style="padding-top: 5px;padding-left: 10px">
                                    <div class="input-group">
                                        <span class="input-group-addon">煤炭名称</span>
                                        <input type="text" id="s_name" placeholder="请输入煤炭名称"
            ...
            <div class="row" id="coalData">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default toggle ">
                        ...
                        <div class="panel-body">
                            <table id="coalDataTables" class="table table-striped table-bordered table-hover"
                ...
                <form id="validate" class="form-horizontal group-border stripped" role="form">
                    <div class="form-group">
                        <label for="name" class="col-lg-4 control-label"
                               style="width:30%;padding-left: 20px;padding-right: 1px">煤炭名称:</label>
                    ...
                    <div class="form-group">
                        <label for="mnc" class="col-lg-4 control-label"
                               style="width:30%;padding-left: 20px;padding-right: 1px">煤炭简记符:</label>
                        <div class="col-lg-10" style="width: 300px;padding-left: 5px">
                    ...
                    <div class="form-group">
                        <label for="kind" class="col-lg-4 control-label"
                               style="width:30%;padding-left: 20px;padding-right: 1px">煤炭种类:</label>
                        <div class="col-lg-10" style="width: 300px;padding-left: 5px">
                            <input type="text" id="kind" class="form-control required" aria-required="true"
                                   placeholder="煤炭种类">
                        </div>
                    </div>
                </form>
