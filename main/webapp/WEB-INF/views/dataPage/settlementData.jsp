            ...
            <div class="row" id="settlementData">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default toggle ">
                        <!-- Start .panel -->
                        <div class="panel-heading">
                            <h4 class="panel-title"><i class="fa fa-table">&nbsp;结算单位信息</i>
                            </h4>
                        </div>
                        <div class="panel-body">
    ...
    <div class="modal-dialog" style="width: 550px">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">添加结算信息</h4>
            </div>
...
<script src="<c:url value="/js/views/dataPage/settlementData.js"/> "></script>
