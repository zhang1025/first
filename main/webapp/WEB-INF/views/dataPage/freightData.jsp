            ...
            <div class="row" id="coalData">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default toggle ">
                        ...
                        <div class="panel-body">
                            <table id="coalDataTables" class="table table-striped table-bordered table-hover" cellspacing="0"  width="100%">
                            </table>
                        </div>
                    </div>
                    <!-- End .panel -->
            ...
            <div class="modal-body">
                <form id="validate" class="form-horizontal group-border stripped" role="form">
                    <div class="form-group">
                        <label for="name" class="col-lg-4 control-label" style="width:30%;padding-left: 20px;padding-right: 1px">站点名称:</label>
                        <div class="col-lg-10" style="width: 300px;padding-left: 5px">
                            <input type="text" id="name" class="form-control required" aria-required="true" placeholder="请输入站点名称">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="mnc" class="col-lg-4 control-label" style="width:30%;padding-left: 20px;padding-right: 1px">站点简记符:</label>
                        <div class="col-lg-10" style="width: 300px;padding-left: 5px">
                            <input type="text" id="mnc" class="form-control required" aria-required="true" placeholder="站点简记符">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="tonnage" class="col-lg-4 control-label" style="width:30%;padding-left: 20px;padding-right: 1px">吨数:</label>
                        <div class="col-lg-10" style="width: 300px;padding-left: 5px">
                            <input type="text" id="tonnage" class="form-control required" name="number" aria-required="true" placeholder="请输入吨数">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="cost" class="col-lg-4 control-label" style="width:30%;padding-left: 20px;padding-right: 1px">运费:</label>
                        <div class="col-lg-10" style="width: 300px;padding-left: 5px">
                            <input type="text" id="cost" class="form-control required" name="number" aria-required="true" placeholder="请输入运费">
                        </div>
                    </div>
                </form>
            </div>
