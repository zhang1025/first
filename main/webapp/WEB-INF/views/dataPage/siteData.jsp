...
<div class="page-content sidebar-page clearfix" style="top:0;">
    ...
    <div class="page-content-wrapper">
        <div class="page-content-inner">
            ...
            <div class="row" id="siteData">
                <div class="col-lg-12">
                    <!-- col-lg-12 start here -->
                    <div class="panel panel-default toggle ">
                        <!-- Start .panel -->
                        <div class="panel-heading">
                            <h4 class="panel-title"><i class="fa fa-table">&nbsp;站点名称</i>
                            </h4>
                        </div>
                        <div class="panel-body">
                            <table id="siteDataTables" class="table table-striped table-bordered table-hover" cellspacing="0"  width="100%">
                            </table>
                        </div>
                    </div>
                    <!-- End .panel -->
    ...
    <div class="modal-dialog" style="width: 550px">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">站点信息</h4>
            </div>
                ...
                <form id="validate" class="form-horizontal group-border stripped" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-lg-10" style="width: 300px;padding-left: 5px">
                            <input type="text" id="name" class="form-control required" aria-required="true" placeholder="站点名称">
                        </div>
                    </div>
                    <div class="form-group">
...
<script src="<c:url value="/js/views/dataPage/siteData.js"/> "></script>
