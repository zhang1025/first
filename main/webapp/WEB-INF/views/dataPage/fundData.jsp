                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 col-md-2 col-lg-2" style="padding-top: 5px;padding-left: 10px">
                                    <div class="input-group">
                                        <span class="input-group-addon">资金方式</span>
                                        <input type="text" id="s_name" placeholder="资金方式"
            ...
            <div class="row" id="fundData">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default toggle ">
                        ...
                        <div class="panel-body">
                            <table id="fundDataTables" class="table table-striped table-bordered table-hover"
                ...
                <form id="validate" class="form-horizontal group-border stripped" role="form">
                    <div class="form-group">
                        <label for="name" class="col-lg-4 control-label"
                               style="width:30%;padding-left: 20px;padding-right: 1px">资金方式:</label>
...
<script src="<c:url value="/js/views/dataPage/fundData.js"/> "></script>
