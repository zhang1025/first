        ...
        <div class="page-content-inner">
            ...
            <div id="page-header" class="clearfix white-bg">
                <div class="page-header">
                    <h2><spring:message code='platData.platTitle' /></h2>
                    <span class="txt"><spring:message code='platData.platTips' /></span>
                </div>
            ...
            <div class="col-lg-12" id="dataReport">
                <div id="platReport">
                    <div class="panel panel-default downLoad toggle " >
                        ...
                        <div class="panel-body">
                            <table id="table-object" class="table table-striped table-bordered table-hover" cellspacing="0"
                                   width="100%">
                                <thead>
                                <tr>
            ...
            <div class="col-lg-12" id="platCompare">
                <div class="panel panel-default  toggle ">
                    <!-- Start .panel -->
                    <div class="panel-heading">
                        <h4 class="panel-title">
                    ...
                    <div class="panel-body">
                        <!-- 平台下拉 -->
                        <div id="plat_select" class="col-lg-2"
                             style="z-index:0;padding: 5px">
                            <div class="input-group">
                                <span class="input-group-addon"><spring:message code="plat"/></span>
                                <select style="font-size: 12px" id="all_platform" class="fancy-select form-control">
                        ...
                        <div id="chart_div">
                            <div id="platChart" style="height:30%"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="<c:url value="/js/views/operationData/platData.js"/> "></script>
<link rel="stylesheet" href="<c:url value="/css/operationData/platData.css"/>" type="text/css">
