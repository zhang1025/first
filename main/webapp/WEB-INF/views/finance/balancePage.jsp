                    ...
                    <div class="panel panel-default toggle ">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <i class="fa fa-table">&nbsp;结算列表</i>
                                <button id="cancelBalance" class="btn btn-warning mr5 mb10" type="button">取消结算</button>
                            </h4>
                        </div>
                        <div class="panel-body">
...
<script src="<c:url value="/js/views/finance/balancePage.js"/> "></script>
