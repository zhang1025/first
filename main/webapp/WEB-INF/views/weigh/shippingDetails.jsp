...
<div class="page-content sidebar-page clearfix" style="top:0;">
    ...
    <div class="page-content-wrapper">
        <div class="page-content-inner">
            ...
            <div class="row" id="shippingDetailsData">
                <div class="col-lg-12">
                    <!-- col-lg-12 start here -->
                    <div class="panel panel-default downLoad toggle ">
                        <!-- Start .panel -->
                        <div class="panel-heading">
                            <h4 class="panel-title"><i class="fa fa-table">&nbsp;发运明细信息</i>
                            </h4>
                        </div>
                        <div class="panel-body">
                            <div style="padding-top: 7px;float: left">
                            </div>
                            <table id="shippingDetailsDataTables" class="table table-striped table-bordered table-hover"
    ...
    <div class="modal-dialog" style="width: 550px">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">发运明细信息</h4>
            </div>
...
<script src="<c:url value="/js/views/weigh/shippingDetails.js"/> "></script>
